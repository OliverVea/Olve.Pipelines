...
// @ts-ignore
import { createPipelineConfigBindingFromDiscriminatorValue, createResultProblemFromDiscriminatorValue, type PipelineConfigBinding, type ResultProblem } from '../../../../models/index.js';
// @ts-ignore
