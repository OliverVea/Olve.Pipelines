...
/**
 * Builds and executes requests for operations under /api/webhooks/github/{triggerId}
 */
 ...
 */
export const WithTriggerItemRequestBuilderUriTemplate = "{+baseurl}/api/webhooks/github/{triggerId}";
/**
