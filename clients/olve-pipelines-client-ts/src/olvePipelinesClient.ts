...
/**
 * Instantiates a new {@link OlvePipelinesClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createOlvePipelinesClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<OlvePipelinesClient>(requestAdapter, pathParameters, OlvePipelinesClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface OlvePipelinesClient extends BaseRequestBuilder<OlvePipelinesClient> {
    /**
     * The api property
     */
 ...
 */
export const OlvePipelinesClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const OlvePipelinesClientNavigationMetadata: Record<Exclude<keyof OlvePipelinesClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
